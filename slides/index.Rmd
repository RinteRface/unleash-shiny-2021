...
- Develop a simple app utilizing a very famous web template (Framework7). 
- This app will consist in:
  - A slider range controlling ...
  - Produce a visualization powered by echarts JS library. 
...
This is a very basic app but it work well.
...
.pull-left[
<div class="md-iphone-5 md-black-device" id="singleLayoutDemo" style="font-size: 0.5em; !important;">
<div class="md-body">
...
.pull-right[
<div class="md-iphone-5 md-white-device" id="tabLayoutDemo" style="font-size: 0.5em; !important;">
<div class="md-body">
<div class="md-buttons"></div>
<div class="md-front-camera"></div>
<div class="md-top-speaker"></div>
...
- Components have 2 default input parameters:
  ...
  - __context__ is a helper providing access to multiple tools:
    - The app instance `$f7`.
    - More [here](https://framework7.io/docs/router-component.html#component-context).
- Components must return a __render__ function. 
...
.pull-left[
- Contains the app layout as a __main__ component.
] 
...
The remaining of `srcjs/framework7.js` initializes the app instance.
...
- Initialize the app instance:
    - Target __app__ id.
    - Set custom theme.
    - Plug the App component in the __component__ slot.
...
# Widget element (1/5): your turn `r emo::ji("experiment")`
...
# Widget element (2/5): your turn `r emo::ji("experiment")`
...
# Widget element (3/5): your turn `r emo::ji("experiment")`

Let's add some `<option>` to the `<select>` tag...

.pull-left[
- Create a `names` array containing `wt`, `hp` and `qsec` strings.
- Map over each array element to build an `<option>`.
- Fill in the `___`.
...
# Widget element (4/5): your turn `r emo::ji("experiment")`
...
# # Widget element (5/5): your turn `r emo::ji("experiment")`
...
# R business logic: your turn `r emo::ji("experiment")`
...
- but ... we can't insert the plot as R code.
...
- Explore the Framework7 card container [documentation](https://framework7.io/docs/cards.html).
...
- Create `renderPlot` function.
- Add `Shiny.addCustomMessageHandler` to capture the message sent from R.
- R `message` is a list with 2 elements: translate into a JS object. 
- Insert `renderPlot` in the component core after `initializeWidget`.
]
