...
Inside the main `srcjs/index.js` we find:
...
- `index.js` the script generated with `{packer}`.
- All of this happens in __app_ui.R__.
- `golem_add_external_resources()` was tweaked ...
]
...
.pull-left[
The most simple layout is composed of:
- A single view.
- A page with navbar, toolbar and page content.
]
...
Inside `srcjs/index.js`, we initialize the app:
...
- JSX: mix HTML and JavaScript code in the same file.
- `file.f7.jsx`.
